 ...
 * 3.数组元素每一个都要放入存钱罐中，也就是逐一处理，for循环
 * 4.如何实现累加呢？ +=
 */
...
public class Demo03ArraySum {
	...
	public static void main(String[] args) {
		...
		array[1] = 80;		//第一件装备，攻击力+80
		array[2] = 150;		//第一件装备，攻击力+150
		array[3] = 50;		//第一件装备，攻击力+50
		array[4] = 90;		//第一件装备，攻击力+90
		array[5] = 200;		//第一件装备，攻击力+200	
		
		int sum = 0;	//存钱罐，不断向其中累加
		//如何求出总攻击力？
		//索引值从0-5有规律，逐一，挨个儿处理，for循环
